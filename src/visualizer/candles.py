...
class InteractiveCandlestickChart:
    ...
    def save_labels_to_file(self):
        ...
        labels_df.to_csv(f"manual_labels_{self.label}.csv", index=False)
        print(f"Labels saved to manual_labels_{self.label}.csv.")
...
# outputpath= f"/Users/ragheb/myprojects/stock/src/files/training/manual_labels/{}/{self.label}_{}_to_{}.csv"
chart = InteractiveCandlestickChart(filepath, "Buy")
chart.show()
